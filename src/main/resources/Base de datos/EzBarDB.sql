...
CREATE TABLE MESAS (
    ...
    ubicacion ENUM('terraza','interior','barra') DEFAULT 'interior',
...
CREATE TABLE PEDIDOS (
    ...
    estado ENUM('pendiente','en_preparacion','listo','entregado','cancelado','pagado') DEFAULT 'pendiente',
